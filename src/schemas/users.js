...
exports.UsersCreateSchema = Joi.object({
  ...
  userTypePreference: Joi.string().required().valid('driver', 'passenger').default('passenger'),
...
exports.UsersUpdateSchema = Joi.object({
  ...
  userTypePreference: Joi.string().optional().valid('driver', 'passenger').default('passenger'),
