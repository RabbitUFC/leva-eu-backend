exports.firstAccessTemplate = (code) => {
  const html = `
    <head>
      ...
      <div class="tg-wrap">
        <table class="tg">
          <thead>
            ...
            <tr>
              <th class="tg-0pky" style="text-align: center;">
                <h1 style="color:#464c5d; font-size:25px; font-weight: bold; text-align: center; margin: 0 0 5px 0;">
                  Bem vindo!
                </h1>
                <p>Seu código de verificaçao é ${code}</p>
